...
from .nodes.magic_control import MagicUniversalSwitch # <--- 新增引入
...
NODE_CLASS_MAPPINGS = {
    ...
    "MagicUniversalSwitch": MagicUniversalSwitch # <--- 新增注册
}
...
print("\n" + "\033[36m" + "="*60 + "\033[0m")
print(f"\033[36m🔮 [Magic Assistant] 已加载 (V3.6 - Universal Switch Added)\033[0m")
